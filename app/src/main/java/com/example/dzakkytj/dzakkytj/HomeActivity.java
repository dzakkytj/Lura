...
public class HomeActivity extends AppCompatActivity {
    ...
    private ImageView imgMaps, imgKontak;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int images[] = {R.drawable.header_lura, R.drawable.header_lura1,R.drawable.header_lura3};
        Locale.setDefault(locale);

        imgMaps = (ImageView) findViewById(R.id.imgMaps);
        imgKontak = (ImageView) findViewById(R.id.imgKontak);
        ...
        imgKontak.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity.this, Kontak.class);
                startActivity(intent);
            }
        });
        ...
        if (mFirebaseUser == null) {
            ...
            Toast.makeText(HomeActivity.this, "Selamat datang di aplikasi Lura Futsal", Toast.LENGTH_SHORT).show();
    ...
    private void showDepositDialog() {
        ...
        alertDialogBuilder
                .setMessage("Untuk dapat melakukan booking jadwal lapangan, anda harus memiliki deposit. " +
                        "Hubungi admin Lura Futsal untuk menambah deposit anda.")
                .setIcon(R.drawable.lura_icon)
                .setCancelable(false)
